...
const AdminStatistics = () => {
  ...
  const levelDistribution = [
    ...
    { name: "HSK 3", value: 68, color: "hsl(var(--success))" },
  ...
  const stats = [
    { title: "Tổng học viên", value: "350", change: "+12%", icon: Users, color: "text-primary" },
    { title: "Điểm trung bình", value: "82", change: "+5%", icon: TrendingUp, color: "text-secondary" },
    { title: "Bài học hoàn thành", value: "1,248", change: "+18%", icon: BookOpen, color: "text-success" },
    { title: "Học viên xuất sắc", value: "45", change: "+8%", icon: Award, color: "text-accent" },
  ];
        ...
        <main className="flex-1 bg-gradient-to-br from-background via-primary/5 to-secondary/10">
          <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="flex h-16 items-center gap-4 px-6">
              <SidebarTrigger />
              <h1 className="text-2xl font-bold">Thống kê điểm học viên</h1>
            </div>
          </header>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={scoreData}>
                      ...
                      <Line type="monotone" dataKey="highest" stroke="hsl(var(--success))" name="Cao nhất" strokeWidth={2} />
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={350}>
                  <BarChart data={scoreData}>
                    ...
                    <Bar dataKey="highest" fill="hsl(var(--success))" name="Cao nhất" />
                    ...
                    {topStudents.map((student, index) => (
                      <TableRow key={student.id}>
                        ...
                        <TableCell className="text-right">
                          <span className="text-lg font-bold text-success">{student.averageScore}</span>
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
